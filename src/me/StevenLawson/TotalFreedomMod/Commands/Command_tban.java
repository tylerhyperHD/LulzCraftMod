...
public class Command_tban extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.adminAction(sender.getName(), "Tempbanning: " + player.getName() + " for 5 minutes.");
        ...
        player.kickPlayer(ChatColor.RED + "You have been temporarily banned for five minutes. Please read http://lulzcraft.net for more info.");
