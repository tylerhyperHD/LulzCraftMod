        ...
        new BukkitRunnable()
        {
            ...
            public void run()
            {
                try
                {
                    ...
                    final String message = ("false".equalsIgnoreCase(in.readLine()) ? ChatColor.RED + "not premium" : ChatColor.GOLD + "premium");
                    in.close();
                    ...
                    new BukkitRunnable()
                    {
                        ...
                        public void run()
                        {
                            playerMsg("Player " + name + " is " + message + ChatColor.GRAY + ".");
                        }
                    }.runTask(plugin);
